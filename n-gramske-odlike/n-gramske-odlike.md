...
**n-gramske odlike** (*n-gram features*)

**Pitanje:** Da li višerečne odlike (bigrami, trigrami) pomažu u prepoznavanju subjektivnosti?

**Ulaz:** `corpus_labeled.tsv` — 3.128 rečenica, 406 članaka, 42,4% SUBJ (1801 OBJ / 1327 SUBJ)
...
| fajl | sadržaj |
|---|---|
| `model/results.tsv` | sirovi rezultati, 200 redova (jedan po sloju) |
| `model/analysis_summary.tsv` | sažetak po kombinaciji, 20 redova |
| `model/analyze.py` | skript koji računa sažetak iz `results.tsv` |
